...
func isMatch(_ s: String, _ p: String) -> Bool {
    ...
    let charsS = Array(s), charsP = Array(p)
    var dp: [[Bool]] = [[Bool]](repeating: [Bool](repeating: false, count: charsP.count+1), count: charsS.count+1)
    dp[0][0] = true
